    ...
    <div class="container">
        ...
        <div class="about-list">
            <div class="about-item">
                <div class="icon">
                    <img src="{{asset('media/theme/icon-1.png')}}" alt="Icon">
                </div>
            ...
            <div class="about-item">
                <div class="icon">
                    <img src="{{asset('media/theme/icon-2.png')}}" alt="Icon">
                </div>
            ...
            <div class="about-item">
                <div class="icon">
                    <img src="{{asset('media/theme/icon-3.png')}}" alt="Icon">
                </div>
    ...
    <div class="container">
        ...
        <div class="popular-restaurant-list">
            ...
            <div class="popular-restaurant-item">
                <div class="img-box">
                    <img src="{{asset('media/categories/'.$category->cat_image)}}" alt="Resturent">
                </div>
                <div class="info-box">
                    <div class="location">
                        <p class="address p-text">{{ str_limit(strip_tags($category->cat_name), 25) }} ({{$category->getItems->count()}})</p>
                        <a href="{{url('/menu/'.$category->id )}}" class="btn-square">Menu</a>
                    </div>
                    <div class="clear"></div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="homeimg-box">
                    <img src="{{asset('media/theme/chef.png')}}">
                </div>
            </div>
        </div>
    </div>
