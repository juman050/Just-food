<div class="modal-dialog">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('Backend\CategoryController@store'), 'method' => 'POST','id' => 'category_add_form', 'class' => '','enctype' => 'multipart/form-data','role'=>'form']) !!}
        <div class="modal-body">

            <div class="form-group col-sm-12">
                {!! Form::label('cat_name', 'Name', array('class' => 'control-label')) !!}
                {!! Form::text('cat_name', null , ['class' => 'form-control cat_name','required' => 'required']); !!}
            ...
            <div class="form-group col-sm-6">
                ...
                @endphp
                {{ Form::select('cat_available_delivery_method', $suatus, null, ['id' => 'cat_available_delivery_method','class' => 'form-control']) }}
            ...
            <div class="form-group col-sm-12">
                ...
                {!! Form::textarea('cat_description', null , ['class' => 'form-control cat_name','required' => 'required']); !!}
