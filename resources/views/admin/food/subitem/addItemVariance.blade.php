    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group col-sm-12">
                ...
                {{ Form::select('item_id', $itemLists , null, ['id' => 'item_id','class' => 'form-control select2','placeholder' => 'Select item','style' => 'width:100%;']) }}
            ...
            <div id="subVarianceTable" style="background: #e7e7e7;width: 100%;height: auto;">
                ...
                <table class="table text-center" id="subVarTable">
                    ...
                    <tbody class="row_position">
                        ...
                        @endphp
                        <tr id="{!! $list->id !!}">
                            <td width="20%"><label class="customLabel"><input type="checkbox" class="flat-red subVariance" name="subVariance" value="{{$list->id}}"></label></td>
