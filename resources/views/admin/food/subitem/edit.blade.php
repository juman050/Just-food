<div class="modal-dialog">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('Backend\SubitemController@update', [$subitem->id]), 'method' => 'PUT', 'id' => 'subitem_edit_form', 'class' => '','role'=>'form']) !!}
        <div class="modal-body">

            {!! Form::hidden('id', $subitem->id ,  ['class' => 'form-control id','required' => 'required']) !!}

            <div class="form-group col-sm-12">
                {!! Form::label('sub_item_name', 'Sub-item name', array('class' => 'control-label')) !!}
                {!! Form::text('sub_item_name', $subitem->sub_item_name , ['class' => 'form-control','required' => 'required']); !!}
            ...
            <div class="form-group col-sm-12">
                ...
                @endphp
                {{ Form::select('required', $requires, $subitem->required, ['id' => 'required','class' => 'form-control']) }}
            ...
            <div class="form-group col-sm-12">
                ...
                {!! Form::text('min_value', $subitem->min_value , ['class' => 'form-control min_value','required' => 'required']); !!}
            ...
            <div class="form-group col-sm-12">
                ...
                {!! Form::text('max_value', $subitem->max_value , ['class' => 'form-control max_value','required' => 'required']); !!}
            ...
            <div class="form-group col-sm-12">
                ...
                @endphp
                {{ Form::select('status', $suatus, $subitem->status, ['id' => 'status','class' => 'form-control']) }}
