        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    {!! Form::open(['url' => action('Backend\ItemController@store'), 'method' => 'POST', 'id' => 'storeForm','class' => 'itemForm', 'enctype' => 'multipart/form-data', 'role'=>'form']) !!}
                    ...
                    <div class="box-body row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            {!! Form::text('item_new_price', null, ['class' => 'form-control']); !!}
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            {!! Form::text('item_old_price', null, ['class' => 'form-control']); !!}
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            {{ Form::select('item_cat_id', $categories, null, ['placeholder' => 'Please select category','id' => 'item_cat_id','class' => 'form-control select2']) }}
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            {{ Form::select('item_allergies[]', $allergies, null, ['multiple' => 'multiple','data-placeholder' => 'Choose allergies','id' => 'item_allergies','class' => 'form-control select2']) }}
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            @endphp
                            {{ Form::select('item_delivery_type', $delivery_type, null, ['id' => 'item_delivery_type','class' => 'form-control']) }}
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            @endphp
                            {{ Form::select('item_variance', $yesNo, null, ['id' => 'item_variance','class' => 'form-control']) }}
                            @if ($errors->has('cus_text_field'))
                            <p class="help-block error_login">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            $yesNo = array('no'=>'No','yes'=>'Yes');
                            @endphp
                            {{ Form::select('item_sub_menu', $yesNo, null, ['id' => 'item_sub_menu','class' => 'form-control']) }}
                            @if ($errors->has('cus_text_field'))
                            <p class="help-block error_login">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            $yesNo = array('no'=>'No','yes'=>'Yes');
                            @endphp
                            {{ Form::select('item_sp_request_sts', $yesNo, null, ['id' => 'item_sp_request_sts','class' => 'form-control']) }}
                            @if ($errors->has('cus_text_field'))
                            <p class="help-block error_login">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            @endphp
                            {{ Form::select('item_offer_include', $yesNo, null, ['id' => 'item_offer_include','class' => 'form-control']) }}
                            @if ($errors->has('cus_text_field'))
                            <p class="help-block error_login">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            @endphp
                            {{ Form::select('item_spice_level', $spiceArray, null, ['id' => 'item_spice_level','class' => 'form-control']) }}
                            @if ($errors->has('cus_text_field'))
                            <p class="help-block error_login">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            {!! Form::text('cus_int_field', null, ['class' => 'form-control']); !!}
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            {!! Form::text('cus_text_field', null, ['class' => 'form-control']); !!}
                            @if ($errors->has('cus_text_field'))
                            <p class="help-block error_login">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            @endphp
                            {{ Form::select('cus_tinyInt_field', $statusArray, null, ['id' => 'cus_tinyInt_field','class' => 'form-control']) }}
                        </div>
                        ...
                        <div class="form-group col-sm-8">
                            ...
                            {!! Form::textarea('item_description', null, ['class' => 'form-control textarea']); !!}
