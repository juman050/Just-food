<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            {!! Form::open(['url' => action('Backend\VarianceController@store'), 'method' => 'POST', 'id' => 'variance_add_form', 'class' => '','role'=>'form']) !!}
            <div class="modal-body">

                <div class="form-group col-sm-12">
                    {!! Form::label('variance_name', 'Variance name', array('class' => 'control-label')) !!}
                    {!! Form::text('variance_name', null , ['class' => 'form-control variance_name','required' => 'required','onfocus' => 'this.value = "";','autocomplete' => 'off']); !!}
                ...
                <div class="form-group col-sm-12">
                    ...
                    {{ Form::select('item_id', $items, null, ['id' => 'item_id','class' => 'form-control select2','style' => 'width:100%']) }}
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::text('item_new_price', null , ['class' => 'form-control item_new_price','required' => 'required']); !!}
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::text('item_old_price', null , ['class' => 'form-control item_old_price']); !!}
