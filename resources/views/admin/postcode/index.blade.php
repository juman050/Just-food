            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <button type="button" class="btn btn-sm btn-primary btn-modal pull-right" data-href="{{action('Backend\PostcodeController@create')}}" data-container=".postcode_modal"><i class="fa fa-plus"></i> Add</button>
                    </div>
...
@section('js')
    ...
    <script src="{{ asset('admin/pages/postcode.js') }}"></script>
