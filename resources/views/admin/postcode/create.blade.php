<div class="modal-dialog">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('Backend\PostcodeController@store'), 'method' => 'POST', 'id' => 'postcode_add_form', 'class' => '','role'=>'form']) !!}
        <div class="modal-body">

            <div class="form-group col-sm-12">
                {!! Form::label('postcode_area', 'Postcode', array('class' => 'control-label')) !!}
                {!! Form::text('postcode_area', null , ['class' => 'form-control postcode_area','required' => 'required']); !!}
            ...
            <div class="form-group col-sm-12">
                ...
                {!! Form::text('postcode_delivery_charge', null , ['class' => 'form-control postcode_delivery_charge','required' => 'required']); !!}
            ...
            <div class="form-group col-sm-12">
                ...
                {!! Form::text('postcode_minimum_order', null , ['class' => 'form-control postcode_minimum_order','required' => 'required']); !!}
