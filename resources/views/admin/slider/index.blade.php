...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            @if(isset($singleData))
            <a href="{{route('slider.index')}}"  class="btn btn-primary btn-sm pull-right" ><i class="fa fa-plus"></i> Add New Slider</a>
            @else
                        ...
                        <table class="table table-striped text-center" id="Table">
                            ...
                            <tbody class="row_position">
                                ...
                                <tr id="{!! $list->id !!}">
                                    ...
                                    <td style="text-align: left !important;"><img height="70" src="{{ asset('media/sliders/'.$list->image) }}"></td>
                                    <td style="text-align: left !important;">{{$list->alt}}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('slider.edit',$list->id) }}" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                        <a href="javascript:void(0);" onclick="deleteSlider({!! $list->id !!})" class="btn btn-xs btn-danger del{{$list->id}}"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                @else
            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <div class="box-body row">
                        ...
                        <div class="form-group col-sm-12">
                            @if($image)
                            <img src="{{asset('media/sliders/'.$image)}}" style="width: 100%;">
                            @endif
                            {!! Form::label('image','Slider image') !!}  <span class="recommended">Recommended size : 1170x600 pixels </span>
                        ...
                        <div class="form-group col-sm-12">
                            {!! Form::label('alt', 'Alt', array('class' => 'control-label')) !!}
                            {!! Form::text('alt', $alt , ['class' => 'form-control','required' => 'required']); !!}
                            @if ($errors->has('alt'))
                            <p class="help-block error_login">
