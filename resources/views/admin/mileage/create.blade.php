<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            {!! Form::open(['url' => action('Backend\MileageController@store'), 'method' => 'POST', 'id' => 'mileage_add_form', 'class' => '','role'=>'form']) !!}
            <div class="modal-body">

                <div class="form-group col-sm-12">
                    {!! Form::label('mileage_length', 'Mileage length', array('class' => 'control-label')) !!}
                    {!! Form::text('mileage_length', null , ['class' => 'form-control mileage_length','required' => 'required']); !!}
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::text('mileage_delivery_charge', null , ['class' => 'form-control mileage_delivery_charge','required' => 'required']); !!}
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::text('mileage_minimum_order', null , ['class' => 'form-control mileage_minimum_order','required' => 'required']); !!}
