    ...
    <div class="container">
        ...
        <div class="col-md-6 col-xs-12 col-md-offset-3">
            ...
            <div id="cart-checkout" class="cus_str">
                ...
                <form role="form" action="<?php echo e(route('stripe.post')); ?>" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="<?php echo e(config('app.STRIPE_KEY')); ?>" id="contact">

                    <?php echo e(csrf_field()); ?>


                    <input hidden="hidden" type="hidden" name="amount" value="<?php echo e($total); ?>">
                    <input hidden="hidden" type="hidden" name="order_id" value="<?php echo e($insertedOrderId); ?>">
                    ...
                    <div class="clearfix"></div>
                    <div class="form-group col-sm-12">
                        <?php echo e(Form::button('Pay now '.\Session::get('currency').' '.$total,['type' => 'submit','id' => 'table-submit','name' => 'Pay now','class' => 'or_btn'])); ?>
