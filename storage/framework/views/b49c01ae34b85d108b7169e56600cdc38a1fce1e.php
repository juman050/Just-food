<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?php echo Form::open(['url' => action('Backend\VarianceController@update', [$lists->id]), 'method' => 'PUT', 'id' => 'variance_edit_form', 'class' => '','role'=>'form']); ?>

        <div class="modal-body">

            <?php echo Form::hidden('id', $lists->id ,  ['class' => 'form-control id','required' => 'required']); ?>

            <div class="form-group col-sm-12">
                <?php echo Form::label('variance_name', 'Variance name', array('class' => 'control-label')); ?>

                <?php echo Form::text('variance_name', $lists->variance_name ,  ['class' => 'form-control variance_name','required' => 'required','onfocus' => 'this.value = "";','autocomplete' => 'off']);; ?>
            ...
            <div class="form-group col-sm-12">
                ...
                <?php echo e(Form::select('item_id', $items, $lists->item_id, ['id' => 'item_id','class' => 'form-control select2','style' => 'width:100%'])); ?>
            ...
            <div class="form-group col-sm-12">
                ...
                <?php echo Form::text('item_new_price', $lists->item_new_price , ['class' => 'form-control item_new_price','required' => 'required']);; ?>
            ...
            <div class="form-group col-sm-12">
                ...
                <?php echo Form::text('item_old_price', $lists->item_old_price , ['class' => 'form-control item_old_price']);; ?>
            ...
            <div class="form-group col-sm-12">
                ...
                ?>
                <?php echo e(Form::select('status', $suatus, $lists->status, ['id' => 'status','class' => 'form-control'])); ?>
