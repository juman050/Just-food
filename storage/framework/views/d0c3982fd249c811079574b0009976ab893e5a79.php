<?php if($methodType=='collection'): ?>
    <?php
        $sippingCharge = 0.00;
        $postcode = $storeDatas->store_postcode;
    ?>
<?php endif; ?>

<?php if($methodType=='delivery'): ?>
...
<div class="post_code_section">
    ...
    <div class="delivery_area">
        ...
        <p class="zipcode_hint"><?php if(\Session::get('postcode')): ?> Delivery postcode is : <?php echo e(\Session::get('postcode')); ?>  <?php endif; ?></p>
    </div>
