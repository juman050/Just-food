<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?php echo Form::open(['url' => action('Backend\CategoryController@update',[$category->id]), 'method' => 'PUT','id' => 'category_edit_form', 'class' => '','enctype' => 'multipart/form-data','role'=>'form']); ?>
        ...
        <div class="modal-body">
            ...
            <?php echo Form::text('cat_name', $category->cat_name , ['class' => 'form-control cat_name','required' => 'required']);; ?>
            ...
            <div class="form-group col-sm-4">
                <img src="<?php echo e(asset('media/categories/'.$category->cat_image)); ?>" height="60px;" class="pull-right">
            </div>
            <div class="clearfix"></div>
            ...
            <div class="form-group col-sm-6">
                ...
                ?>
                <?php echo e(Form::select('cat_available_delivery_method', $suatus,  $category->cat_available_delivery_method, ['id' => 'cat_available_delivery_method','class' => 'form-control'])); ?>
            ...
            <div class="form-group col-sm-6">
                ...
                ?>
                <?php echo e(Form::select('status', $suatus,  $category->status, ['id' => 'status','class' => 'form-control'])); ?>
            ...
            <div class="form-group col-sm-12">
                ...
                <?php echo Form::textarea('cat_description',  $category->cat_description , ['class' => 'form-control cat_name','required' => 'required']);; ?>
