<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1><?php echo e($data['pageName']); ?><small><?php echo e($data['pageTagLine']); ?></small></h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-aqua">
                        <div class="inner">
                            <h3><?php echo e($data['total_pending_orders']); ?></h3>
                            <p>Pending Orders</p>
                        </div>
                        <div class="icon"><i class="ion ion-bag"></i></div>
                        <a href="<?php echo e(url('backoffice/orders/pending')); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-green">
                        <div class="inner">
                            <h3><?php echo e($data['total_orders']); ?></h3>
                            <p>Total Orders</p>
                        </div>
                        <div class="icon"><i class="ion ion-stats-bars"></i></div>
                        <a href="<?php echo e(url('backoffice/order')); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-yellow">
                        <div class="inner">
                            <h3><?php echo e($data['total_users']); ?></h3>
                            <p>Users</p>
                        </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-red">
                        <div class="inner">
                            <h3><?php echo e(\Session::get('currency')); ?> <?php echo e($data['total_earning']); ?></h3>
