            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <button style="margin-left: 10px;" type="button" class="btn btn-sm btn-primary btn-modal pull-right" data-href="<?php echo e(action('Backend\SubitemController@create')); ?>" data-container=".subitem_modal"><i class="fa fa-plus"></i> Add new sub-items</button>&nbsp;&nbsp;&nbsp;&nbsp;
...
<script src="<?php echo e(asset('admin/pages/subitem.js')); ?>"></script>
