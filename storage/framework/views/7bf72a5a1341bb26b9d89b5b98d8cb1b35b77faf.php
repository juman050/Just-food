    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group col-sm-11">
                ...
                <?php echo e(Form::select('item_id', $itemLists , $item_id, ['id' => 'item_id','class' => 'form-control select2','placeholder' => 'Select item','style' => 'width:100%;','disabled' => 'disabled'])); ?>
            ...
            <div class="form-group col-sm-1">
                ...
                <a href="javascript:void(0)" data-link="<?php echo e(url('backoffice/food/deleteSubItemVariance/'.$id)); ?>" class="sub_var_delete"><i class="fa fa-trash" style="color: white;padding: 10px;background: #1abc9c;"></i></a>
                ...
                <table class="table text-center" id="subVarTable">
                    ...
                    <tbody class="row_position">
                        ...
                        <tr id="<?php echo $list->id; ?>">
                            <td width="20%"><label class="customLabel"><input type="checkbox" class="flat-red subVariance" name="subVariance" value="<?php echo e($list->id); ?>" <?php if(in_array($list->id, $checkArray)){echo 'checked';} ?> ></label></td>
