    ...
    <section class="content-header">
      <h1>
        ...
        <ol class="breadcrumb">
          ...
          <?php if(isset($singleData)): ?>
          <a href="<?php echo e(route('gallery.index')); ?>"  class="btn btn-primary btn-sm pull-right" ><i class="fa fa-plus"></i> Add New Gallery</a>
          <?php else: ?>
      ...
      <div class="col-md-8">
        ...
        <tbody class="row_position">
            ...
            <tr id="<?php echo $list->id; ?>">
              ...
              <td style="text-align: left !important;"><img height="70" src="<?php echo e(asset('media/gallery/'.$list->image)); ?>"></td>
              ...
              <td>
                <a href="<?php echo e(route('gallery.edit',$list->id)); ?>" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                <a href="javascript:void(0);" onclick="deleteGallery(<?php echo $list->id; ?>)" class="btn btn-xs btn-danger del<?php echo e($list->id); ?>"><i class="fa fa-trash"></i></a>
            </td>
        </tr>
...
<div class="col-md-4">
    ...
    <div class="box-body row">
      ...
      <div class="form-group col-sm-12">
          <?php if($image): ?>
          <img src="<?php echo e(asset('media/gallery/'.$image)); ?>" style="width: 100%;">
          <?php endif; ?>
          <?php echo Form::label('image','Gallery image'); ?>  <span class="recommended">Recommended size : 600x400 pixels </span>
...
<script src="<?php echo e(asset('admin/pages/gallery.js')); ?>"></script>
<?php $__env->stopSection(); ?>
